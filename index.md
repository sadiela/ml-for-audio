...
A white paper providing more comprehensive details on the available data can be found <a href="NeurIPS_2023___AudioWorkshop_DataBenchmark.pdf" target="_blank">here</a>. To request access to the datasets, please reach out to [competitions@hume.ai](mailto:competitions@hume.ai).
